...
if (file_exists('../libs/dbconnect.php')) {
    $tally = $tally+1;
}
if (file_exists('../logs/bannedips.log')) {
    $tally = $tally+1;
}
if (is_writable('../logs/bannedips.log')) {
    $tally = $tally+1;
}
if (file_exists('../logs/domain-blacklist.log')) {
    $tally = $tally+1;
}
if (is_writable('../logs/domain-blacklist.log')) {
    $tally = $tally+1;
}
if (file_exists('../logs/domain-whitelist.log')) {
    $tally = $tally+1;
}
if (is_writable('../logs/domain-whitelist.log')) {
    $tally = $tally+1;
}
if (is_writable('../admin/backup/')) {
    $tally = $tally+1;
}
if (is_writable('../avatars/groups_uploaded/')) {
    $tally = $tally+1;
}
if (is_writable('../avatars/user_uploaded/')) {
    $tally = $tally+1;
}
...
foreach (glob("../languages/*.conf") as $filename) {
    if (!is_writable($file)) {
        echo '<tr><td><i class="fa fa-times"></i></td><td>'.$filename.' is not writable! Please chmod this file to 777.</span></td></tr>';
    }
    if (is_writable($file)) {
        echo '<tr><td><i class="fa fa-check"></i></td><td>'.$filename.'</span></td></tr>';
    }
}
