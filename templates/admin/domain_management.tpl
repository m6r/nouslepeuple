		...
		{if $whitelist_file|@count != '0'}
			...
			<table class="table table-striped table-condensed">
				{section name=line loop=$whitelist_file}
					<tr>
						<td><a href="domain_management.php?id=0&list=whitelist&remove={$whitelist_file[line]}"><i style="color:#dd1c1c;" class="fa fa-clock-os"></i></a>
		...
		{if $blacklist_file|@count != '0'}
			...
			<table class="table table-striped table-condensed">
				{section name=line loop=$blacklist_file}
					<tr>
						<td><a href="domain_management.php?id=0&list=blacklist&remove={$blacklist_file[line]}"><i style="color:#dd1c1c;" class="fa fa-clock-os"></i></a>
